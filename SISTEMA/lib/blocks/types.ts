...
export type BlockSizeVariant = "small" | "medium" | "large" | "";

export interface BlockLayoutData {
  width?: BlockWidth;
  sizeVariant?: BlockSizeVariant;
  minHeight?: string;
}

export interface HeroBlockData extends BlockLayoutData {
  headline: string;
  subheadline?: string;
  ctaLabel?: string;
  ctaHref?: string;
...
export const BLOCK_DATA_DEFAULTS: Record<PageBlockType, object> = {
  ...
  DUAL_NARRATIVE: {
    leftTitle: "",
    leftText: "",
    leftHref: "/collections/for-herself",
    leftImageUrl: "",
    rightTitle: "",
    rightText: "",
    rightHref: "/collections/for-her",
    rightImageUrl: "",
  },
  HIGH_JEWELRY: {
    productHandles: [],
