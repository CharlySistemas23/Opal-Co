...
export async function PUT(
  ...
  if (body.productType !== undefined) updates.productType = body.productType?.trim() || null;
  ...
  if (body.careText !== undefined) updates.careText = body.careText ?? null;
  if (body.detailsText !== undefined) updates.detailsText = body.detailsText ?? null;
