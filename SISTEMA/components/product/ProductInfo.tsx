...
const collapsibleSections = [
  { id: "details", title: "Details", content: "Handcrafted with precision. Each piece is unique." },
  { id: "care", title: "Care", content: "Store in a soft pouch. Avoid contact with chemicals." },
];
