...
export function DualNarrativeBlock({ data }: DualNarrativeBlockProps) {
  ...
  const leftHref = data.leftHref || "/collections/for-herself";
  const rightHref = data.rightHref || "/collections/for-her";
      ...
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          <RevealOnScroll delay={0}>
            <Link href={leftHref} className="group block bg-stone">
          ...
          <RevealOnScroll delay={0.1}>
            <Link href={rightHref} className="group block bg-stone">
              <div className="relative aspect-[3/4] overflow-hidden">
                <Image
                  src={rightImage}
                  alt=""
