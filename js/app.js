...
const App = {
    ...
    async loadWeeklyPayroll() {
        try {
            ...
            // Tienda 1 (L Vallarta): Chely 3000, Ximena 2500, Ana 1500, Dulce 2000 → total 9000 semanal
            if (branch1) {
                payrollCosts.push({
                    id: Utils.generateId(),
                    type: 'fijo',
                    ...
                    recurring: true,
                    auto_generate: true,
                    notes: 'Nómina semanal: Chely 3000, Ximena 2500, Ana 1500, Dulce 2000',
                    created_at: new Date().toISOString(),
                    sync_status: 'pending'
                });
            }

            // Tienda 2 (Malecón): Andrea 2000, Itzel 2000, Guille 2500 → total 6500 semanal
            if (branch2) {
                payrollCosts.push({
                    id: Utils.generateId(),
                    type: 'fijo',
                    ...
                    recurring: true,
                    auto_generate: true,
                    notes: 'Nómina semanal: Andrea 2000, Itzel 2000, Guille 2500',
                    created_at: new Date().toISOString(),
                    sync_status: 'pending'
                });
            }

            // Tienda 3 (San Sebastián): Omar 2000, Juan Carlos 2000 → total 4000 semanal
            if (branch3) {
                payrollCosts.push({
                    id: Utils.generateId(),
                    type: 'fijo',
                    ...
                    recurring: true,
                    auto_generate: true,
                    notes: 'Nómina semanal: Omar 2000, Juan Carlos 2000',
                    created_at: new Date().toISOString(),
                    sync_status: 'pending'
                });
            }

            // Tienda 4 (Sayulita): Omar 2000, Juan Carlos 2000, Fany 1500, Covarrubias 1000 → total 6500 semanal
            if (branch4) {
                payrollCosts.push({
                    id: Utils.generateId(),
                    type: 'fijo',
                    ...
                    recurring: true,
                    auto_generate: true,
                    notes: 'Nómina semanal: Omar 2000, Juan Carlos 2000, Fany 1500, Covarrubias 1000',
                    created_at: new Date().toISOString(),
                    sync_status: 'pending'
                });
            }
