...
const Costs = {
    ...
    async getCostsTab() {
        return `
            ...
            <div id="costs-list" style="max-height: 600px; overflow-y: auto; width: 100%; overflow-x: auto;"></div>
        `;
    },
    ...
    async getRecurringTab() {
        return `
            <div style="margin-bottom: var(--spacing-md); display: flex; gap: var(--spacing-sm); flex-wrap: wrap;">
                <button class="btn-primary btn-sm" id="recurring-generate-btn" style="white-space: nowrap;">
                    <i class="fas fa-magic"></i> Generar Costos Recurrentes Faltantes
                </button>
                <button class="btn-secondary btn-sm" id="recurring-add-btn" style="white-space: nowrap;">
                    <i class="fas fa-plus"></i> Nuevo Recurrente
                </button>
            </div>
            <div id="recurring-list" style="max-height: 600px; overflow-y: auto; width: 100%; overflow-x: auto;"></div>
        `;
    },
