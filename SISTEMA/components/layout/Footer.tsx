    ...
    <footer className="bg-charcoal text-ivory py-20 md:py-30">
      <Container>
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-12">
          <span className="font-serif text-2xl tracking-tight whitespace-nowrap">{t("header_brand_text", "OPAL & CO")}</span>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
          <p className="font-sans text-sm text-ivory/60 order-2 sm:order-1">
            © {currentYear} {t("header_brand_text", "OPAL & CO")}. {t("footer_copyright", "All rights reserved.")}
          </p>
          <nav
