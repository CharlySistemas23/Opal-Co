    ...
    <div className="mt-4 pt-4 border-t border-charcoal/10 space-y-2">
      ...
      <div className="flex gap-4 items-center">
        <label className="flex items-center gap-2">
          <span className="text-xs text-charcoal/70">Width:</span>
          <select
            className={inputClass}
            value={(d.width as string) ?? "full"}
        ...
        <label className="flex items-center gap-2">
          <span className="text-xs text-charcoal/70">Size:</span>
          <select
            className={inputClass}
            value={(d.sizeVariant as string) ?? ""}
            onChange={(e) => update("sizeVariant", e.target.value || undefined)}
          >
        ...
        <>
          <div className="space-y-4">
            <div className="border border-charcoal/10 rounded p-3">
              ...
              />
              <label className={labelClass}>Left link (href)</label>
              <input
                type="text"
                className={inputClass}
                value={(d.leftHref as string) ?? "/collections/for-herself"}
                onChange={(e) => update("leftHref", e.target.value)}
                placeholder="/collections/for-herself"
              />
            ...
            <div className="border border-charcoal/10 rounded p-3">
              ...
              />
              <label className={labelClass}>Right link (href)</label>
              <input
                type="text"
                className={inputClass}
                value={(d.rightHref as string) ?? "/collections/for-her"}
                onChange={(e) => update("rightHref", e.target.value)}
                placeholder="/collections/for-her"
              />
