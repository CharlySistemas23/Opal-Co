...
const BarcodeManager = {
    ...
    async handlePOSScan(barcode) {
        try {
            ...
            // NOTA: No requerimos guía/vendedor para escanear productos
            // Las validaciones se harán al completar la venta
            ...
            if (item) {
                ...
                // pero solo si no hay guía/vendedor (sugerir el flujo completo)
