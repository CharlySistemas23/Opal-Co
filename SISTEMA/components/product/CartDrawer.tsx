              ...
              {!isCartAvailable ? (
                <div className="py-20 text-center space-y-6">
                  <Text variant="body" muted>
                    {t("cart_unavailable_message", "Shopping bag is unavailable. Please contact us to complete your purchase.")}
                  </Text>
                  <Link
                    href="/contact"
                    onClick={closeCart}
                ...
                <div className="py-20 text-center space-y-4">
                  <Text variant="body" muted>
                    {t("cart_empty_message", "Your bag is empty.")}
                  </Text>
                  <Link
                    href="/collections"
                    onClick={closeCart}
