        ...
        >
          <div className="flex items-center border-b border-charcoal/10">
            <input
              ...
              placeholder={t("search_placeholder", "Search pieces")}
              autoComplete="off"
            ...
            {query.trim() && !isLoading && !error && results.length === 0 && (
              <div className="py-8 text-center space-y-4">
                <Text variant="body" muted>
                  {t("search_no_results_prefix", "No results for")} “{query}”
                </Text>
                <button
                  type="button"
                  onClick={() => {
                  ...
                  <li key={r.handle}>
                    ...
                    >
                      ...
                      <span className="font-sans text-sm text-charcoal/80">
                        {r.byInquiry ? t("search_by_inquiry", "By inquiry") : formatPrice(r.price, "USD")}
                      </span>
                    </button>
                  </li>
                ))}
