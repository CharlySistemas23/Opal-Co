        ...
        <RevealOnScroll>
          <div className="max-w-[600px] mx-auto text-center">
            ...
            <Text variant="body" muted className="mb-8">
              {t("newsletter_body", "Receive early access to new collections, stories from the atelier, and invitations to private events.")}
            </Text>
            {submitted ? (
              <Text variant="body" className="text-charcoal">
                {t("newsletter_thank_you", "Thank you. Please check your email to confirm.")}
              </Text>
            ) : (
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  ...
                  disabled={loading}
                >
                  {loading ? "Subscribing..." : t("newsletter_button", "Subscribe")}
                </Button>
              </form>
            )}
          </div>
